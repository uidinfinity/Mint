...
public record QuadElement(RenderPipeline pipelines, TextureSetup textureSetup, Matrix3x2f matrix3x2f,
		...
		implements SimpleGuiElementRenderState
{
	...
	public QuadElement(RenderPipeline pipelines, TextureSetup textureSetup, Matrix3x2f matrix3x2f,
	                   float left, float top, float right, float bottom, Color color,
	...
	public QuadElement(RenderPipeline pipelines, TextureSetup textureSetup, Matrix3x2f matrix3x2f, float left,
