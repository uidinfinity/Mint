        ...
        implements SimpleGuiElementRenderState
{
    ...
    public SidewaysGradientElement(RenderPipeline pipelines, TextureSetup textureSetup, Matrix3x2f matrix3x2f,
                       float left, float top, float right, float bottom,  Color startColor, Color endColor,
    ...
    public SidewaysGradientElement(RenderPipeline pipelines, TextureSetup textureSetup, Matrix3x2f matrix3x2f, float left,
    ...
    public void setupVertices(VertexConsumer vertices, float depth) {
        ...
        vertices.vertex(matrix3x2f, left, bottom, depth).color(startColor.getRGB());
        vertices.vertex(matrix3x2f, right, bottom, depth).color(endColor.getRGB());
        vertices.vertex(matrix3x2f, right, top, depth).color(endColor.getRGB());
    }
