...
@FeatureInfo(name = "ThrowFirework", category = Category.Player)
public class ThrowFireworkFeature extends Feature {
    ...
    public void onEnable() {
        ...
        Slot slot = Services.INVENTORY.findSlot(SearchLogic.All, Items.FIREWORK_ROCKET);
